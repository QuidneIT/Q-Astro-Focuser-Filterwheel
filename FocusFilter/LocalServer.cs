...
namespace ASCOM.QAstroFF
{
    ...
    {
//        public const string SwitchDriverId = "ASCOM.QAstroFF";
//        public const string SwitchDriverName = "Q-Astro Focuser & Filter";
        ...
        private static string s_appId = "{962703a1-acf0-42ad-a836-c4a8caf46984}";	// Our AppId
        ...
        private static bool LoadComObjectAssemblies()
        {
            ...
            foreach (FileInfo fi in d.GetFiles("ASCOM.QAstroFF*.dll"))
            {
                ...
                catch (Exception e)
                {
                    MessageBox.Show("Failed to load served COM class assembly " + fi.Name + " - " + e.Message,
                        "ASCOM QA", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    return false;
                }
        ...
        private static void ElevateSelf(string arg)
        {
            ...
            {
                MessageBox.Show("The ASCOM QA was not " + (arg == "/register" ? "registered" : "unregistered") +
                    " because you did not allow it.", "ASCOM QA", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.ToString(), "ASCOM QA", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
            return;
        }
                ...
                switch (args[0].ToLower())
                {
                    ...
                    default:
                        MessageBox.Show("Unknown argument: " + args[0] + "\nValid are : -register, -unregister and -embedding",
                            "ASCOM QA", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        break;
                }
            }
            else
