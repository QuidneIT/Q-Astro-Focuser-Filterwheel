...
[Files]
Source: "{#OneDrivePath}\Development\Q-Astro\{#AppName}\{#AppVersion}\FocusFilter\bin\{#ReleaseType}\ASCOM.QAstroFF.FilterWheel.dll"; DestDir: "{app}" ;Flags: ignoreversion
Source: "{#OneDrivePath}\Development\Q-Astro\{#AppName}\{#AppVersion}\FocusFilter\bin\{#ReleaseType}\ASCOM.QAstroFF.Focuser.dll"; DestDir: "{app}" ;Flags: ignoreversion
Source: "{#OneDrivePath}\Development\Q-Astro\{#AppName}\{#AppVersion}\FocusFilter\bin\{#ReleaseType}\ASCOM.QAstroFF.exe"; DestDir: "{app}" ;Flags: ignoreversion
Source: "{#OneDrivePath}\Development\Q-Astro\{#AppName}\{#AppVersion}\FocusFilter\bin\{#ReleaseType}\MetroFramework.dll"; DestDir: "{app}" ;Flags: ignoreversion
Source: "{#OneDrivePath}\Development\Q-Astro\{#AppName}\{#AppVersion}\FocusFilter\bin\{#ReleaseType}\LBIndustrialCtrls.dll"; DestDir: "{app}" ;Flags: ignoreversion
Source: "{#OneDrivePath}\Development\Q-Astro\{#AppName}\{#AppVersion}\FocusFilter\bin\{#ReleaseType}\ASCOM.QAstroFF.FocusFilterApp.exe"; DestDir: "{app}"  ; Flags: ignoreversion
