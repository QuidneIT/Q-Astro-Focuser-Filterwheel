...
; Last Updated on 27/08/2022 (UTC)
;
#define AppVersion = "2.0.7"
#define AppName = "Q-Astro FocusFilter"

;Used for Icon and Registration
#define MainFile = "ASCOM.QAstroFF.FocusFilterApp.exe"
#define ServerFile ="ASCOM.QAstroFF.exe"
...
AppName=ASCOM Q-Astro FocusFilter
...
[Files]
Source: "{#SourcePath}\Development\Q-Astro\{#AppName}\{#AppVersion}\FocusFilter\bin\{#ReleaseType}\ASCOM.QAstroFF.FilterWheel.dll"; DestDir: "{app}" ;Flags: ignoreversion
Source: "{#SourcePath}\Development\Q-Astro\{#AppName}\{#AppVersion}\FocusFilter\bin\{#ReleaseType}\ASCOM.QAstroFF.Focuser.dll"; DestDir: "{app}" ;Flags: ignoreversion
Source: "{#SourcePath}\Development\Q-Astro\{#AppName}\{#AppVersion}\FocusFilter\bin\{#ReleaseType}\MetroFramework.dll"; DestDir: "{app}" ;Flags: ignoreversion
Source: "{#SourcePath}\Development\Q-Astro\{#AppName}\{#AppVersion}\FocusFilter\bin\{#ReleaseType}\LBIndustrialCtrls.dll"; DestDir: "{app}" ;Flags: ignoreversion
Source: "{#SourcePath}\Development\Q-Astro\{#AppName}\{#AppVersion}\FocusFilter\bin\{#ReleaseType}\{#ServerFile}"; DestDir: "{app}" ;Flags: ignoreversion
Source: "{#SourcePath}\Development\Q-Astro\{#AppName}\{#AppVersion}\FocusFilter\bin\{#ReleaseType}\{#MainFile}"; DestDir: "{app}"  ; Flags: ignoreversion
